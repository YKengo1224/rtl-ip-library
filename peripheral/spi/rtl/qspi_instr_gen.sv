...
module qspi_instr_gen #(
    ...
    output logic                       qspi_int_ms_rx_fifo_overflow_set_aclk_o_r,
    output logic                       qspi_int_ms_tx_fifo_overflow_set_aclk_o_r,
    output logic                       qspi_int_ms_rx_fifo_threshold_set_aclk_o_r,
    output logic                       qspi_int_ms_tx_fifo_threshold_set_aclk_o_r,
    output logic                       qspi_int_ms_rx_fifo_not_empty_set_aclk_o_r,
    output logic                       qspi_int_ms_tx_fifo_empty_set_aclk_o_r,
    // instr signal
    ...
    always_comb begin
        qspi_int_rs_rx_fifo_overflow_aclk = (qspi_status_rx_fifo_full_aclk_i && qspi_data_rx_data_write_trigger_aclk_i);
        qspi_int_rs_tx_fifo_overflow_aclk = (qspi_status_tx_fifo_full_aclk_i && qspi_data_tx_data_write_trigger_aclk_i);
        qspi_int_rs_rx_fifo_threshold_aclk = (qspi_status_rx_fifo_num_aclk_i <= qspi_threshold_level_rx_threshold_level_aclk_i);
        qspi_int_rs_tx_fifo_threshold_aclk = (qspi_status_tx_fifo_available_aclk_i <= qspi_threshold_level_tx_threshold_level_aclk_i);
    ...
    always_ff @(posedge aclk or negedge aresetn) begin
        if (!aresetn) begin
            qspi_int_ms_rx_fifo_overflow_set_aclk_o_r <= 1'b0;
            qspi_int_ms_tx_fifo_overflow_set_aclk_o_r <= 1'b0;
            qspi_int_ms_rx_fifo_threshold_set_aclk_o_r <= 1'b0;
            qspi_int_ms_tx_fifo_threshold_set_aclk_o_r <= 1'b0;
            qspi_int_ms_rx_fifo_not_empty_set_aclk_o_r <= 1'b0;
            qspi_int_ms_tx_fifo_empty_set_aclk_o_r <= 1'b0;
        end else begin
            qspi_int_ms_rx_fifo_overflow_set_aclk_o_r  <= qspi_int_rs_rx_fifo_overflow_aclk;
            qspi_int_ms_tx_fifo_overflow_set_aclk_o_r  <= qspi_int_rs_tx_fifo_overflow_aclk;
            qspi_int_ms_rx_fifo_threshold_set_aclk_o_r <= qspi_int_rs_rx_fifo_threshold_aclk;
            qspi_int_ms_tx_fifo_threshold_set_aclk_o_r <= qspi_int_rs_tx_fifo_threshold_aclk;
            qspi_int_ms_rx_fifo_not_empty_set_aclk_o_r <= qspi_int_rs_rx_fifo_not_empty_aclk;
            qspi_int_ms_tx_fifo_empty_set_aclk_o_r     <= qspi_int_rs_tx_fifo_empty_aclk;
        end
    end
