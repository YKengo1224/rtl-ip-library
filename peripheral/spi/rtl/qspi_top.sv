...
module qspi_top #(
    ...
    input  wire  [ACTUAL_ID_WIDTH-1:0] awid,
    ...
    output logic                       bvalid,
    input  wire                        bready,
    output logic [ACTUAL_ID_WIDTH-1:0] bid,
    output logic [                1:0] bresp,
    input  wire                        arvalid,
    output logic                       arready,
    input  wire  [  ADDRESS_WIDTH-1:0] araddr,
    input  wire  [ACTUAL_ID_WIDTH-1:0] arid,
    input  wire  [                2:0] arprot,
    output logic                       rvalid,
    input  wire                        rready,
    output logic [ACTUAL_ID_WIDTH-1:0] rid,
    ...
    logic [15:0]        qspi_data_data_aclk;    // From qspi_axi4lite_slv_inst of qspi_axi4lite_slv.v
    logic               qspi_data_data_read_trigger_aclk;// From qspi_axi4lite_slv_inst of qspi_axi4lite_slv.v
    logic               qspi_data_data_write_trigger_aclk;// From qspi_axi4lite_slv_inst of qspi_axi4lite_slv.v
    ...
    logic               qspi_instr_aclk;        // From qspi_instr_gen_inst of qspi_instr_gen.v
    ...
    logic               qspi_int_rs_rx_fifo_threshold_aclk;// From qspi_instr_gen_inst of qspi_instr_gen.v
    logic               qspi_int_rs_tx_fifo_empty_aclk;// From qspi_instr_gen_inst of qspi_instr_gen.v
    logic               qspi_int_rs_tx_fifo_overflow_aclk;// From qspi_instr_gen_inst of qspi_instr_gen.v
    logic               qspi_int_rs_tx_fifo_threshold_aclk;// From qspi_instr_gen_inst of qspi_instr_gen.v
    ...
    logic [15:0]        qspi_master_clk_clk_divisor_sysclk;// From qspi_sync_pclk2sysclk of qspi_sync_pclk2sysclk.v
    wire [15:0]         qspi_rx_fifo_data_in_sysclk;// From qspi_core of qspi_core.v
    ...
    logic [BITWIDTH-1:0] qspi_status_rx_fifo_data_out_aclk;// From rx_fifo of qspi_rx_fifo_async.v
    ...
    logic [BITWIDTH-1:0] qspi_status_rx_fifo_fifo_num_aclk;// From rx_fifo of qspi_rx_fifo_async.v
    ...
    logic               qspi_status_rx_fifo_w_en_aclk;// From rx_fifo of qspi_rx_fifo_async.v
    ...
    logic [BITWIDTH-1:0] qspi_status_tx_fifo_fifo_available_aclk;// From tx_fifo of qspi_tx_fifo_async.v
    ...
    logic [4:0]         qspi_theshold_level_rx_theshold_level_aclk;// From qspi_axi4lite_slv_inst of qspi_axi4lite_slv.v
    logic [4:0]         qspi_theshold_level_tx_theshold_level_aclk;// From qspi_axi4lite_slv_inst of qspi_axi4lite_slv.v
    logic               qspi_tx_fifo_data_out_sysclk;// From tx_fifo of qspi_tx_fifo_async.v
    ...
    /*qspi_axi4lite_slv AUTO_TEMPLATE (
     .o_QSPI_DATA_data\(.*\) (QSPI_DATA_tx_data\1_aclk[][]),
    ...
    /*AUTOINST*/
                                              ...
                                              .o_qspi_data_data (qspi_data_data_aclk[15:0]), // Templated
                                              .o_qspi_data_data_write_trigger(qspi_data_data_write_trigger_aclk), // Templated
                                              .o_qspi_data_data_read_trigger(qspi_data_data_read_trigger_aclk), // Templated
                                              ...
                                              .o_qspi_theshold_level_rx_theshold_level(qspi_theshold_level_rx_theshold_level_aclk[4:0]), // Templated
                                              .o_qspi_theshold_level_tx_theshold_level(qspi_theshold_level_tx_theshold_level_aclk[4:0]), // Templated
                                              ...
                                              // Inputs
                                              .i_qspi_data_data (qspi_data_data_aclk[15:0]), // Templated
    ...
    /*AUTOINST*/
                                        // Outputs
                                        .qspi_int_rs_rx_fifo_overflow_aclk_o_r(qspi_int_rs_rx_fifo_overflow_aclk), // Templated
                                        .qspi_int_rs_tx_fifo_overflow_aclk_o_r(qspi_int_rs_tx_fifo_overflow_aclk), // Templated
                                        .qspi_int_rs_rx_fifo_threshold_aclk_o_r(qspi_int_rs_rx_fifo_threshold_aclk), // Templated
                                        ...
                                        .qspi_instr_aclk_o_r(qspi_instr_aclk), // Templated
                                        // Inputs
                                        .aclk           (aclk),
                                        .arestn         (arestn),
                                        ...
                                        .qspi_status_tx_fifo_available_aclk_i(qspi_status_tx_fifo_available_aclk[4:0]), // Templated
                                        ...
                                        .qspi_status_rx_fifo_num_aclk_i(qspi_status_rx_fifo_num_aclk[4:0]), // Templated
                                        .qspi_tx_data_write_trigger_aclk_i(qspi_tx_data_write_trigger_aclk), // Templated
                                        .qspi_rx_data_write_trigger_aclk_i(qspi_rx_data_write_trigger_aclk), // Templated
                                        ...
                                        .qspi_rx_threshold_level_aclk_i(qspi_rx_threshold_level_aclk[4:0]), // Templated
                                        .qspi_tx_threshold_level_aclk_i(qspi_tx_threshold_level_aclk[4:0])); // Templated
    ...
    /* qspi_tx_fifo_async AUTO_TEMPLATE "tx_fifo" (
        ...
        .data_in_wclk (qspi_data_tx_data_aclk),
        .data_out_rclkr (qspi_tx_fifo_data_out_sysclk),
    ...
    /*AUTOINST*/
               // Outputs
               .data_out_rclkr  (qspi_tx_fifo_data_out_sysclk), // Templated
               ...
               .fifo_available_wclkr(qspi_status_tx_fifo_fifo_available_aclk[BITWIDTH-1:0]), // Templated
               ...
               .data_in_wclk    (qspi_data_tx_data_aclk), // Templated
    ...
    /* qspi_rx_fifo_async AUTO_TEMPLATE "rx_fifo" (
        ...
        .rclk         (aclk),
        .rst_n_rclk   (aresetn),     
        .r_en_rclk (qspi_data_data_read_trigger),
        .data_in_wclk(qspi_rx_fifo_data_in_sysclk),
        .w_en_wclk (spi_rx_fifo_w_en_sysclk),
    ...
    /*AUTOINST*/
                                                 ...
                                                 .qspi_master_clk_clk_divisor_sysclk_o(qspi_master_clk_clk_divisor_sysclk[15:0]), // Templated
                                                 // Inputs
                                                 .aclk                  (aclk),
                                                 .sysclk                (sysclk),
                                                 .aresetn               (aresetn),
                                                 .srstn_sysclk          (srstn_sysclk),
                                                 .qspi_sclk_in_i        (qspi_sclk_in),  // Templated
                                                 .qspi_csn_in_i         (qspi_csn_in[3:0]), // Templated
                                                 .qspi_data_in_i        (qspi_data_in[3:0]), // Templated
                                                 ...
                                                 .qspi_master_clk_clk_divisor_aclk_i(qspi_master_clk_clk_divisor_aclk[15:0])); // Templated
    ...
    /*AUTOINST*/
                         ...
                         .qspi_master_clk_clk_divisor_sysclk_i(qspi_master_clk_clk_divisor_sysclk[15:0]), // Templated
