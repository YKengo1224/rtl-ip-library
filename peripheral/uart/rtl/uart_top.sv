...
module uart_top #(
    ...
    wire                int_framing_err_raw_set_aclk;// From uart_sync_sysclk2aclk of uart_sync_sysclk2aclk.v
    ...
    uart_sync_aclk2sysclk uart_sync_aclk2sysclk (
        /*AUTOINST*/
                                                 ...
                                                 .i_conf_clk_div_aclk   (conf_clk_div_aclk[15:0])); // Templated
    ...
    uart_sync_sysclk2aclk uart_sync_sysclk2aclk (
        /*AUTOINST*/
                                                 ...
                                                 .o_int_framing_err_raw_set_aclkr(int_framing_err_raw_set_aclk), // Templated
                                                 ...
                                                 .i_rx_detect_break_sysclk(rx_detect_break_sysclk)); // Templated
    ...
    uart_clk_divider uart_clk_divider (
        /*AUTOINST*/
                                       ...
                                       .i_conf_clk_div_sysclk(conf_clk_div_sysclk[15:0])); // Templated
    ...
    uart_tx uart_tx (
        /*AUTOINST*/
                     ...
                     .i_uart_ctsn_sysclk(uart_ctsn_sysclk));     // Templated
    ...
    uart_rx uart_rx (
        /*AUTOINST*/
                     ...
                     .i_uart_rxd_sysclk (uart_rxd_sysclk));      // Templated
