...
| TBD    | QSPI_DATA       | 0x00   | QSPIデータレジスタ                    |                                 |
| TBD    | QSPI_INT        | 0x00   | QSPI割り込みコントロールレジスタ      |                                 |
| TBD    | QSPI_STATUS     | 0x00   | QSPI FIFOステータスレジスタ           |                                 |
| TBD    | QSPI_INTR_RS    | 0x00   | QSPI 割り込み生ステータスレジスタ     |                                 |
| TBD    | QSPI_INTR_MS    | 0x00   | QSPI 割り込みマスクステータスレジスタ |                                 |
| TBD    | QSPI_           |        |                                      |                                 |
...
| [24]    | order          | R/W        | 1'b0   | 送信順序選択<br>0:LSBファースト<br>1:MSBファースト                                                                               |
...
=| [15:12] | word_width     | R/W        | 4'b0   | 転送ワード幅設定<br>Double転送、Quad転送の場合は無効です                                                                         |
...
| [15:0]  | clk_divisor | R/W        | 16'd1  | SPI転送レート設定<br>$$\frac{F_{sysclk}}{2(clk\_divisor + 1)}$$ |
