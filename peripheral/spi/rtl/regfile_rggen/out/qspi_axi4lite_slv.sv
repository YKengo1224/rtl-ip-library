...
#(
  ...
  parameter bit [4:0] QSPI_THRESHOLD_LEVEL_RX_THRESHOLD_LEVEL_INITIAL_VALUE = 5'h0a,
  parameter bit [4:0] QSPI_THRESHOLD_LEVEL_TX_THRESHOLD_LEVEL_INITIAL_VALUE = 5'h0a,
