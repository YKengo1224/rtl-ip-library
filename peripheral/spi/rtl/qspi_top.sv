...
module qspi_top #(
    ...
    logic [$clog2(
FIFO_SIZE
):0] qspi_status_rx_fifo_fifo_num_aclk;  // From rx_fifo of qspi_rx_fifo_async.v
    ...
    logic [$clog2(
FIFO_SIZE
):0] qspi_status_tx_fifo_available_aclk;  // From tx_fifo of qspi_tx_fifo_async.v
    ...
    qspi_axi4lite_slv qspi_axi4lite_slv_inst (
        ...
        .i_qspi_int_ms_tx_fifo_empty_set(qspi_int_ms_tx_fifo_empty_set_aclk)
    );  // Templated
    ...
    qspi_instr_gen qspi_instr_gen_inst (
        ...
        .qspi_status_tx_fifo_available_aclk_i(qspi_status_tx_fifo_available_aclk[$clog2(
            FIFO_SIZE
        ):0]),  // Templated
        ...
        .qspi_status_rx_fifo_num_aclk_i(qspi_status_rx_fifo_num_aclk[$clog2(
            FIFO_SIZE
        ):0]),  // Templated
        ...
        .qspi_threshold_level_tx_threshold_level_aclk_i(qspi_threshold_level_tx_threshold_level_aclk[4:0])
    );  // Templated
    ...
    qspi_sync_pclk2sysclk qspi_sync_pclk2sysclk (
        ...
        .qspi_master_clk_clk_divisor_aclk_i(qspi_master_clk_clk_divisor_aclk[15:0])
    );  // Templated
    ...
    qspi_core #(
        ...
        .qspi_data_in_sysclk_i(qspi_data_in_sysclk[3:0])
    );  // Templated
